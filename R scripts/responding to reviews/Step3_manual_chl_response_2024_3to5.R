#### run the code but with heatwaves identified as
# events lasting 3-5 days wiht temps 3-5 degrees above
# the seasonally-varying baseline



##### manual chlorophyll response if heatwaves are calculated just with normal temp data,
# no modeling



### calculate chlorophyll results with different heatwaves and approaches
...
#==============================================================================#
#### loop through the whole code to investigate across heatwave thresholds ####
...
heatwaves = read.csv("./results/heatwave modeled outputs/heatwave events LRT 3 to 5 days 3 to 5 degrees.csv")
...
png("./figures/revisions draft 2025-01-27/S3 heatwave results 2_or_3 days after 3to5.png", height = 7, width = 10, units = "in", res = 600)
